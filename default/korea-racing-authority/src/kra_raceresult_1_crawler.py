...
url = 'https://apis.data.go.kr/B551015/API4_1/raceResult_1'
...
if total_count == 0:
    ...
    file_path = f'/lake/red/korea_racing_authority/raceresult_1/year={search_date_dt.year}/month={search_date_dt.month}.json.gz' 
